...
class package(models.Model):
    ...
    Sender_Email= models.EmailField(("Sender Email Address"), max_length=50)
    Sender_Address= models.CharField(("Sender Address"), max_length=50)
    Sender_Contact= models.CharField(("Sender Contact"), max_length=15)

    Receiver_FullName= models.CharField(("Receiver Fullname"), max_length=50)
    Receiver_Email= models.EmailField(("Receiver Email address"), max_length=50)
    Receiver_Address= models.CharField(("Receiver Address"), max_length=50)
    Receiver_Contact= models.CharField(("Receiver Contact"), max_length=15)
